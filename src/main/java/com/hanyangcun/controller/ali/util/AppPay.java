package com.hanyangcun.controller.ali.util;
...
public class AppPay {
	...
	public static String getSign(JSONObject map, String key) throws Exception {
		...
		if(map.getString("sign_type").equals("HMAC-SHA256")) {
